...
public class TestEduITUAvailable extends Test {
  // both connectable, Eduroam given first
  // should be ITU++
  public int test1() {
    DeviceAPI.API = new DeviceAPI_EduITU();
  ...
  // Eduroam connectable, Eduroam given first
  // should be Eduroam
  public int test2() {
    DeviceAPI.API = new DeviceAPI_EduITU();
  ...
  // ITU connectable, Eduroam given first
  // should be ITU++
  public int test3() {
    DeviceAPI.API = new DeviceAPI_EduITU();
  ...
  // None connectable, Eduroam given first
